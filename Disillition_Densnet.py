...
num_epochs = 20
learning_rate = 0.001
T = 20.0  # Temperature for distillation
...
teacher_model = densenet161(pretrained=True)
# retrain the classifier for CIFAR-10
teacher_model.classifier = nn.Linear(teacher_model.classifier.in_features, 100)
teacher_model.to(device).eval()
print('Teacher model DenseNet loaded and adapted the final layer to CIFAR10.')


## load the sutdent model untrained ResNet18
model = ResNet18()
